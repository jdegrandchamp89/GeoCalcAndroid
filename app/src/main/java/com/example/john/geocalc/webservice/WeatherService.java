package com.example.john.geocalc.webservice;
...
public class WeatherService extends IntentService {
    ...
    private static final String ACTION_WEATHER_AT = "com.example.john.geocalc.webservice.action.WEATHER_AT";
    private static final String BASE_URL = "https://api.darksky.net/forecast/7f3173cabdddf922996c78147dde3c55";
    public static final String BROADCAST_WEATHER = "com.example.john.geocalc.webservice.action.BROADCAST";
    // TODO: Rename parameters
    private static final String EXTRA_KEY = "com.example.john.geocalc.webservice.extra.KEY";
    private static final String EXTRA_LAT = "com.example.john.geocalc.webservice.extra.LAT";
    private static final String EXTRA_LNG = "com.example.john.geocalc.webservice.extra.LNG";
    private static final String EXTRA_TIME = "com.example.john.geocalc.webservice.extra.TIME";
    ...
    public static void startGetWeather(Context context, String lat, String lng, String key) {
        Intent intent = new Intent(context, com.example.john.geocalc.webservice.WeatherService.class);
